...
: ${AMENT_CURRENT_PREFIX:="/home/user/my_project/color-follower-ros2/install/mobile_world"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mobile_world/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mobile_world/environment/path.sh"
